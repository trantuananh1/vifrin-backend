...
public abstract class HotelMapper {
    ...
    @Mapping(target = "hasSwimmingPool", source = "hotel.hasSwimmingPool")
    @Mapping(target = "hasParking", source = "hotel.hasParking")
    @Mapping(target = "hasWifi", source = "hotel.hasWifi")
    @Mapping(target = "hasAirConditioner", source = "hotel.hasAirConditioner")
    @Mapping(target = "hasElevator", source = "hotel.hasElevator")
    @Mapping(target = "hasRestaurant", source = "hotel.hasRestaurant")
    @Mapping(target = "hasBathroom", source = "hotel.hasBathroom")
